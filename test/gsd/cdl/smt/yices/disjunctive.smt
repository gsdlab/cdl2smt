;; . . . . . . . . . . . . . . . . . .
;; Translation of the file C:\Users\leonardo\Documents\NetBeansProjects\ece725-project\test\gsd\cdl\smt\yices\disjunctive.iml

(define-type ROM_MONITOR_scalar (scalar Generic GDB_stubs ))

(define-type STARTUP_scalar (scalar FLOPPY ROM RAM GRUB ))

(define CYGBLD_ISO_TZSET_HEADER_data_var::int)

(define ROM_MONITOR_scalar_var::ROM_MONITOR_scalar)

(define CYGBLD_ISO_SCHEDTYPES_HEADER_bool_var::bool)

(define CYGBLD_ISO_TZSET_HEADER_bool_var::bool)

(define CYGBLD_ISO_SCHEDTYPES_HEADER_data_var::int)
